...
List<DemoItem> buildBasicDemoItems(String codePath) {
  return [
    ...
    DemoItem(
      ...
      keyword: 'ElevatedButton',
      documentationUrl: 'https://api.flutter.dev/flutter/widgets/ElevatedButton-class.html',
      buildRoute: (context) => BaseWidget('ElevatedButton ButtonTheme', codePath + 'lib/category/widgets/buttons/ElevatedButton', ElevatedButtonWidget()),
    ),
    DemoItem(
      icon: Icons.format_bold,
      title: 'Row',
